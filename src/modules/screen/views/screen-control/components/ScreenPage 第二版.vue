  ...
  <section class="screen-page">
    <section class="pad-b-30 steps-one pad-t-20" style="width:100%;">
      ...
      <el-row class="pad-b-20 pad-r-30 batch-title pad-l-20 pad-t-10">
        ...
        <!-- <el-col :lg="3" :xl="3" :push="1">{{ firstData.flawDescribe }}</el-col> -->
      </el-row>
      <el-row>
        <el-col :lg="6" :xl="6" class="mark-image pad-l-20 mar-r-30" :offset="2">
        ...
        <el-col :lg="5" class="mark-num">
          <el-row>
            <el-col>
              ...
              <time-circle :totalTime="screenData.totalTime" :setTimer="screenData.lessTime"></time-circle>
            </el-col>
          </el-row>
        </el-col>
        <el-col :lg="7" class="mark-num" :offset="3">
          <el-row>
            <el-col>
              <time-circle :totalTime="screenData.totalTime" :setTimer="screenData.lessTime"></time-circle>
